...
const Register = () => {
    const { handleRegistration, signInWithGoogle,  getEmail, getPassword, getRePassword, handleNameChanged, handlePhoneChanged, toggleLogin } = useAuth();
            ...
            <div className="container login-form ">
                <div className="py-5">
                    ...
                    <div className="text-lg-start px-2">
                        <button onClick={handleGoogleLogin} type="submit" className="btn btn-success me-2">Google Sign In</button>
